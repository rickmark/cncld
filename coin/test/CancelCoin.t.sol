...
contract CounterTest is Test {
    ...
    function setUp() public {
        ...
        address proxy = Upgrades.deployUUPSProxy(
            ...
            abi.encodeCall(
                CancelCoin.initialize, (address(adminSigner), address(pauserSigner), minter, address(upgradeSigner))
            )
        );
    ...
    function test_DoubleMintCancel() public {
        ...
        coin.cancel(zach, "Donald Trump", 5000);
        vm.expectRevert(
            abi.encodeWithSelector(CancelCoin.AlreadyCanceledError.selector, DONALD_TRUMP, "Donald Trump", 5000)
        );
        vm.prank(minter);
